      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white rounded-xl p-8 shadow-medium space-y-6">
          ...
          <div className="bg-ivory p-6 rounded-lg">
            ...
            <ul className="list-disc list-inside space-y-2 text-text-mid">
          ...
          <div>
            ...
            <ol className="list-decimal list-inside space-y-2 text-text-mid">
            ...
            <p className="text-sm text-text-mid mt-4 italic">
          ...
          {/* CTA */}
          <div className="pt-6 border-t border-warm-beige">
            <Link
