...
export default function MetodyZakonceniPage() {
  const methods = [
    ...
    {
      title: 'Vlasové tresy (sewing wefts)',
  ...
  return (
    <div className="py-12 bg-ivory min-h-screen">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        {/* Info Box */}
        <div className="bg-white rounded-xl p-8 shadow-medium max-w-4xl mx-auto">
          <h2 className="text-2xl font-playfair text-burgundy mb-4">
            Jak vybrat správnou metodu?
          </h2>
          <div className="space-y-3 text-gray-700">
            <p>
              <strong>Pro husté vlasy:</strong> Keratin / Mikrokeratin - nejtrvanlivější řešení s přirozeným výsledkem.
            </p>
            <p>
              <strong>Pro jemné vlasy:</strong> Tape-in (nano tapes) - nejšetrnější metoda, která nezatěžuje kořínky.
            </p>
            <p>
              <strong>Pro kudrnaté/afro vlasy:</strong> Vlasové tresy (sewing wefts) - tradiční metoda bez chemie a tepla.
            </p>
            <p className="text-sm text-gray-600 italic mt-4">
              Potřebujete poradit? <Link href="/kontakt" className="text-burgundy hover:underline">Kontaktujte nás</Link>
            </p>
          </div>
        </div>
      </div>
