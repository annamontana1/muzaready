...
export default function PlatinumEditionTierPage() {
  ...
  const fetchProducts = useCallback(() => {
    setLoading(true);
    let url = '/api/catalog?tier=Platinum+edition';
    ...
    <div className="py-12">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
            Exkluzivní panenské vlasy v Platinum Edition kvalitě.
          </motion.p>
        </motion.div>
        ...
        <div className="mt-16 pt-12 border-t border-warm-beige">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              { name: 'Baby Shades', href: '/vlasy-k-prodlouzeni/baby-shades', desc: 'Jemné dětské vlasy v přirozených odstínech.' },
            ].map((tier) => (
              <Link
                key={tier.name}
                href={tier.href}
