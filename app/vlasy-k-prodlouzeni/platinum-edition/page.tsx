...
export default function PlatinumEditionTierPage() {
  ...
  const fetchProducts = useCallback(() => {
    setLoading(true);
    let url = '/api/catalog?tier=PLATINUM_EDITION';
  ...
  return (
    <div style={{ background: 'var(--ivory)' }}>
        ...
        <div className="flex items-end justify-between mb-6">
          <div>
            ...
            <h1 className="font-cormorant font-light leading-none" style={{ fontSize: 'clamp(24px,3vw,36px)', color: 'var(--text-dark)' }}>
              Vlasy k prodloužení <em className="italic" style={{ color: 'var(--burgundy)' }}>Platinum Edition</em>
            </h1>
          </div>
          <Link
            ...
            <div className="mb-8">
              ...
              <div className="flex gap-2 flex-wrap">
                {([
                  ...
                  { label: 'Nebarvené světlé', value: 'nebarvene_svetle' as const },
                ]).map(({ label, value }) => (
                  <button
                    key={value}
              ...
              {filters.colorType === 'nebarvene_svetle' && (
                <p className="mt-3 text-[11px] font-light italic" style={{ color: 'var(--text-soft)' }}>
            ...
            {hasActiveFilters && (
              <div className="mt-6 pt-6 flex flex-wrap gap-2" style={{ borderTop: '1px solid var(--beige)' }}>
                {filters.colorType && (
                  ...
                  >
                    {filters.colorType === 'nebarvene' ? 'Nebarvené' : filters.colorType === 'barvene' ? 'Barvené' : 'Nebarvené světlé'}
      ...
      <div className="px-3 md:px-12 py-12" style={{ background: 'var(--white)' }}>
        <div className="max-w-7xl mx-auto">
          <SimilarFromOtherTiers currentTier="Platinum edition" activeShades={filters.shades} />
        </div>
      </div>
